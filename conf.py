...
BLOG_AUTHOR = "NA"  # (translatable)
BLOG_TITLE = "control + enter:"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://mandarup.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://mandarup.github.io/"
BLOG_EMAIL = "NA"
BLOG_DESCRIPTION = "mostly a tech blog, but who knows"  # (translatable)
